...
export const theme = {
  bubble: {
    user: { bg: colors.bgUser, border: colors.borderUser, text: colors.accentUser },
    agent: { bg: colors.bgAgent, border: colors.borderAgent, text: colors.accentAgent },
    thinking: { bg: colors.bgThinking, border: colors.borderThinking, text: colors.accentThinking },
    system: { bg: colors.bgSecondary, border: colors.borderSubtle, text: colors.accentSystem },
    tool: { bg: colors.bgSecondary, border: colors.accentTool, text: colors.accentTool },
  }
};
